...
public class PBKDF2PasswordHandler implements PasswordHandler {
     ...
     */
    PBKDF2PasswordHandler(SaltGenerator saltGenerator, int hashByteSize, int nrPBKDF2Iterations) {
    ...
    public boolean equals(Object o) {
        ...
        PBKDF2PasswordHandler that = (PBKDF2PasswordHandler) o;
    ...
    public static class Builder {
        ...
        public PBKDF2PasswordHandler createPasswordMaster() {
            return new PBKDF2PasswordHandler(saltGenerator, hashByteSize, nrPBKDF2Iterations);
        }
    }
}
