...
public class PolicyManagerImpl implements PolicyManager, Serializable {
    private static final long serialVersionUID = -6841245385123569323L;
     ...
     */
    public PolicyManagerImpl(Map<UserId, Map<ProjectId, Set<RoleId>>> userRoleMap) {
    ...
    @Override
    public void remove(UserId userId, ProjectId projectId, RoleId roleId) throws UserNotInPolicyException {
    ...
    @Override
    public Map<UserId, Map<ProjectId, Set<RoleId>>> getUserRoleMappings() {
        return userRoleMap;
    }
