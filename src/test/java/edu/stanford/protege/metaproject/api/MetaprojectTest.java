...
public class MetaprojectTest {
    ...
    private static final UserRegistry userRegistry = Utils.getUserManager(Utils.getUserSet(user1, user2, user3));
    ...
    private static final ProjectRegistry projectRegistry = Utils.getProjectManager(Utils.getProjectSet(project1, project2, project3));
    ...
    private static Policy policy = Utils.getPolicyManager();
