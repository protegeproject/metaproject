...
//
//        config = Utils.getConfiguration(host, root, metaproject, authenticationRegistry, propertyMap);
//        otherServerConfiguration = Utils.getConfiguration(host, root, metaproject, authenticationRegistry, propertyMap);
//        diffServerConfiguration = Utils.getConfiguration(diffHost, root, metaproject, authenticationRegistry, propertyMap);
//
