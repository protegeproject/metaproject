...
public class CustomOperationTest {
    ...
    @Before
    public void setUp() {
        operation = TestUtils.getCustomOperation(operationId, operationName, operationDescription, operationType, scope);
        otherOperation = TestUtils.getCustomOperation(operationId, operationName, operationDescription, operationType, scope);
        diffOperation = TestUtils.getCustomOperation(diffOperationId, diffOperationName, operationDescription, operationType, scope);
    }
